/**
 * AAGUID -> friendly authenticator name, so the passkey list can show
 * "1Password" or "iCloud Keychain" instead of a raw transport list.
 *
 * Sourced from the community-maintained public registry at
 * https://github.com/passkeydeveloper/passkey-authenticator-aaguids
 * (combined_aaguid.json, fetched 2026-08-23). Non-exhaustive — an
 * unrecognized or all-zero AAGUID is expected and falls back to the
 * transport list in describeDevice().
 */
export const AAGUID_NAMES: Record<string, string> = {
  ...
  "18852056-063b-4042-9814-7d0d383081f9": "SECORA ID Key S USB by Infineon Enterprise Edition",
  ...
  "55fd881f-40ba-4eaf-8435-42c5fed08b76": "SECORA ID V2 by Infineon Consumer Edition",
...
/** Looks up a friendly authenticator name for an AAGUID, if known. */
export function describeAaguid(aaguid: string | null | undefined): string | null {
